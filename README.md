...
|  | **Funções de Probabilidade Úteis**                       |
|:-----------|:-----------------------------------------------------|
...
|  | **Análise Exploratória de Dados - 1D**                   |
|:-----------|:-----------------------------------------------------|
...
|  | **Análise Exploratória de Dados - 2D**                   |
|:-----------|:-----------------------------------------------------|
...
|  | **Inferindo Funções de Probabilidade a partir de Dados** |
|:-----------|:-----------------------------------------------------|
...
| **Definições:**| Verossimilhança, Princípio da Máxima Verossimilhança, Logaritmo da Verossimilhança de um conjunto de dados sob um modelo |
| **Termos:**    | Consistência do estimador, Teste Chi-quadrado para qualidade do ajuste, Teste Kolmogorov-Smirnov |
| **Habilidades:** | Estimar parâmetros pela máxima verossimilhança (MLE), Definir funções de verossimilhança para diferentes distribuições de probabilidade, Estimar os parâmetros de diferentes modelos por MLE a partir de dados, Descrever situações onde a estimativa via MLE não é confiável |
